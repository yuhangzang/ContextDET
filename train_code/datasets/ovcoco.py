...
def build(image_set, args, processor):
    ...
    img_folder = root
    if image_set == 'train':
        ann_file = root / "annos_v2" / f'{dataset}_{tokenizer}_instances_train2017_seen.json'
    elif image_set == 'val':
        ann_file = root / "annos_v2" / f'{dataset}_{tokenizer}_instances_val2017_all.json'
